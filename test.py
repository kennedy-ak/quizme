...
# st.markdown("Convert your text to speech and download as MP3")
...
#     # Create columns for voice parameters
...
# def text_to_speech(text, language_code, speech_speed):
#     try:
#         # Create gTTS object
#         tts = gtts.gTTS(
#             text=text,
#             lang=language_code,
#             slow=(speech_speed < 1.0)
#         )
...
#             audio_path = text_to_speech(text_input, lang_code, speed)
...
#    gtts
#    ```
# 5. Deploy to Streamlit Cloud by pushing to GitHub and connecting your repository
# """)
